/******/ (() => {
    ...
    /******/ var __webpack_modules__ = {
        /***/ "./src/section19-basicTypes/Aula19-exercicio/form-controls.ts":
            /*!********************************************************************!*\
  !*** ./src/section19-basicTypes/Aula19-exercicio/form-controls.ts ***!
  \********************************************************************/
            /***/ function (
                ...
                const isStrongPassword_1 = __importDefault(
                    __webpack_require__(
                        /*! validator/lib/isStrongPassword */ "./node_modules/validator/lib/isStrongPassword.js",
                    ),
                );
                ...
                function showErrorMessage(input, message) {
                    ...
                    const errorMessage =
                        formFields.querySelector(".error-message");
                    errorMessage.innerText = message;
                    formFields.classList.add(SHOW_ERROR_MESSAGE);
                    console.log(message);
                }
                function hideAllErrorMessages(form) {
                    const allFormFields = form.querySelectorAll(
                        "." + SHOW_ERROR_MESSAGE,
                    );
                ...
                function checkUsername(input) {
                    if (!input.value || input.value.length < 8) {
                        showErrorMessage(
                            input,
                            "Usuário deve ter no mínimo 8 caracteres",
                        );
                        return false;
                    }
                    return true;
                ...
                function checkPassword(password, password2) {
                    ...
                    if (!password.value || !password2.value) {
                        ...
                        (0, isStrongPassword_1.default)(password.value, {
                            minLength: 8,
                            minLowercase: 1,
                            minUppercase: 1,
                            minNumbers: 1,
                    ...
                    if (
                        ...
                        if (display_email) {
                            ...
                            str = str
                                ...
                                .replace(/(^<|>$)/g, ""); // sometimes need to trim the last space to get the display name
    ...
    */
                    ...
                    if (options.blacklisted_chars) {
                        if (
                            user.search(
                                new RegExp(
                                    "[".concat(options.blacklisted_chars, "]+"),
                                    "g",
                                ),
                            ) !== -1
                        )
 ...
 * * */
                ...
                var IPv4AddressRegExp = new RegExp(
  ...
  \********************************************************/
            /***/ (module, exports, __webpack_require__) => {
                ...
                function scorePassword(analysis, scoringOptions) {
                    var points = 0;
                    points +=
                        analysis.uniqueChars * scoringOptions.pointsPerUnique;
                    points +=
  ...
  \**************************************************/
    ...
    (() => {
        ...
        /*!************************************************************!*\
  !*** ./src/section19-basicTypes/Aula19-exercicio/index.ts ***!
  \************************************************************/

        Object.defineProperty(exports, "__esModule", { value: true });
        __webpack_require__(
            /*! ./form-controls */ "./src/section19-basicTypes/Aula19-exercicio/form-controls.ts",
        );
    })();
