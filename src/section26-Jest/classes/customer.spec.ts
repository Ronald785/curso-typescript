...
describe("IndividualCustomer", () => {
    it("should have firstName, lastName and cpf", () => {
        const sut = createIndividualCustomer("Ronald", "Almeida", "111.111");
        expect(sut).toHaveProperty("firstName", "Ronald");
        expect(sut).toHaveProperty("lastName", "Almeida");
        expect(sut).toHaveProperty("cpf", "111.111");
    });

    it("should have methods to get name and idn for individual customers", () => {
        const sut = createIndividualCustomer("Ronald", "Almeida", "111.111");
        expect(sut.getName()).toBe("Ronald Almeida");
